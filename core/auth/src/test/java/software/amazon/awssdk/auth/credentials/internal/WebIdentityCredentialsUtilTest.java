...
public class WebIdentityCredentialsUtilTest {
    ...
    public void resolveWebIdentityToken_ReturnsWebIdentityTokenString() {
        Path currentDirectory = Paths.get("src/test/resources/token.jwt");
        String webIdentityToken = WebIdentityCredentialsUtils.resolveWebIdentityToken(currentDirectory.toAbsolutePath());
